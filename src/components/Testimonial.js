                    ...
                    <ol class="carousel-indicators tabs">
                        <li data-target="#carouselExampleIndicators" data-slide-to="0" class="active">
                            <figure>
                                ...
                                <figcaption class="img-fluid">Samraddhi Khare</figcaption>
                            </figure>
                        </li>
                        <li data-target="#carouselExampleIndicators" data-slide-to="1">
                            <figure>
                                ...
                                <figcaption class="img-fluid">Surbhi Pandey</figcaption>
                            </figure>
                        </li>
                        <li data-target="#carouselExampleIndicators" data-slide-to="2">
                            <figure>
                                ...
                                <figcaption class="img-fluid">Vineet Singh</figcaption>
                            </figure>
                        </li>
                    </ol>
                </div>
                        ...
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <div class="quote-wrapper">
                                    <p>We have an expert team for house cleaning at an affordable rates.</p>
